...
export const activeEmployee = (employees) => employees.filter((e) => e.active);
...
export const sortBySalaryDesc = (employees) => [...employees].sort((a, b) => b.salary - a.salary); // highest first
